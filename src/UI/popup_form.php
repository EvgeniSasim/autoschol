<?php 
    $madalOptions = get_field('id_popup', 'option');
    $title = $madalOptions['zagolovok'];
    $subTitle = $madalOptions['podzagolovok'];
    $descr = $madalOptions['opisanie'];
...
<?php 
    $scripts = 'modal("'. $idCF7 .'");colorese(".modal-window .trigger-subtitle > p");';
